                                ...
                                child: Padding(
                                  ...
                                  child: Image.asset(
                                    hadAgreeMap.containsKey(userInfo.userId)
                                        ...
                                        : userInfo.isCanAgree
                                            ? "assets/demo/images/before-HandUp.png"
                                            : "assets/demo/images/after-HandUp.png",
                                    height: 30,
                                  ),
                                ),                          
  ...
  Widget build(BuildContext context) {
    ...
    if (UserType.Audience == widget.userType) {
      lastBtnUrl = hadHandUp
          ...
          : "assets/demo/images/noRaiseHand.png";
    } else {
      lastBtnUrl = widget.userStatus == UserStatus.Mute
          ? "assets/demo/images/no-speaking.png"
          : "assets/demo/images/speaking.png";
    }

    String secondBtnUrl = widget.userType == UserType.Administrator
        ? "assets/demo/images/raiseHandList.png"
        : widget.userType == UserType.Anchor
            ? "assets/demo/images/DownWheat.png"
            : "";
