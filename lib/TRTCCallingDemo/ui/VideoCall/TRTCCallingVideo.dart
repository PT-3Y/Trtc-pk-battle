...
import 'package:socialv/TRTCCallingDemo/model/TRTCCalling.dart';
import 'package:socialv/TRTCCallingDemo/model/TRTCCallingDelegate.dart';
import 'package:socialv/TRTCCallingDemo/ui/base/CallTypes.dart';
import 'package:socialv/TRTCCallingDemo/ui/base/CallingScenes.dart';
import 'package:socialv/login/ProfileManager_Mock.dart';
...
class _TRTCCallingVideoState extends State<TRTCCallingVideo> {
                      ...
                      children: [
                        Container(
                          ...
                          child: InkWell(
                            ...
                            child: Image.asset(
                              'assets/demo/images/callingDemo/switch-camera.png',
                              height: 32,
  ...
  getButtomWidget() {
    var callSomeBtnList = [
      _currentCallStatus == CallStatus.answer
          ? ExtendButton(
              imgUrl: _isMicrophoneOff
                  ? "assets/demo/images/callingDemo/microphone-off.png"
                  : "assets/demo/images/callingDemo/microphone-on.png",
              tips: "麦克风",
              onTap: () {
                onMicrophoneTap();
              },
      ...
      ExtendButton(
        imgUrl: "assets/demo/images/callingDemo/hangup.png",
        tips: "挂断",
        onTap: () {
          onHangUpCall();
        },
      ...
      _currentCallStatus == CallStatus.answer
          ? ExtendButton(
              imgUrl: _callingScenes == CallingScenes.VideoOneVOne
                  ? _isCameraOff
                      ? "assets/demo/images/callingDemo/camera-off.png"
                      : "assets/demo/images/callingDemo/camera-on.png"
                  : _isHandsFree
                      ? "assets/demo/images/callingDemo/trtccalling_ic_handsfree_enable.png"
                      : "assets/demo/images/callingDemo/trtccalling_ic_handsfree_disable.png",
              tips:
    ...
    if (_currentCallType == CallTypes.Type_Being_Called &&
      ...
      callSomeBtnList.insert(
        3,
        ExtendButton(
          imgUrl: "assets/demo/images/callingDemo/trtccalling_ic_dialing.png",
          tips: "接听",
          onTap: () {
            onAcceptCall();
          },
