...
class TrtcTokenUtils {
  static String generateToken(int sdkAppID, String serverSecret, String userID,
...
class TokenInfo04 {
  ...
  String toJson() {
    return '{"app_id":$sdkAppID,"user_id":"$userID","nonce":$nonce,"ctime":$ctime,"expire":$expire,"payload":"$payload"}';
  }
}
